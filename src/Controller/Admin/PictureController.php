...
class PictureController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, PictureUploader $pictureUploader): Response
    {
        $picture = new Picture();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($uploadedPicture) {
                $newFileName = $pictureUploader->upload($uploadedPicture);
